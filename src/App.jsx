...
import PlanetFormation             from './pages/PlanetFormation'
  ...
  <Header />
      ...
      <main>
        <Routes>
          ...
          <Route path="/solar-output"                        element={<SolarOutput />}             />
          ...
          <Route path="/earthandspace/planet-formation"              element={<PlanetFormation />}           />
