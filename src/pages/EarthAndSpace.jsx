...
{
  tags:       ['Earth Science', 'Geology', 'Interactive'],
  title:      "Bowen's Reaction Series & Goldich Stability Series",
  description:"Simulate mineral crystallization from cooling magma, then flip to Weathering mode to watch the same minerals break down in reverse stability order — tracing Goldich's sequence and developing a stage-specific soil profile.",
  footerTags: ["Bowen's Series", 'Goldich Stability', 'Weathering', 'Igneous Rocks', 'Soil Development'],
  to:         '/bowensgoldich',
  accentVar:  '--accent-earth',
