...
const SECTIONS = [
  {
    ...
    cards: [
      ...
      {
        tags:       ['ISP', 'WIND', 'HOUR OF DAY'],
        title:      'Wind by Hour Heatmap',
        description:'Heatmap of wind speed and direction patterns by hour of day across the full climatological record at Islip.',
        footerTags: ['Wind Speed', 'Wind Direction', 'Diurnal Pattern'],
        to:         '/wind-hour-heatmap',
        accentVar:  '--accent-hourly',
        thumb:      '/WindHourHeatmap_thumbnail.png',
      },
      {
        tags:       ['ISP', 'HEAT & HUMIDITY'],
        title:      'Dewpoint Threshold Heatmap',
        description:'Monthly frequency of days meeting or exceeding key dewpoint thresholds at Islip — tracking humidity trends from comfortable to oppressive.',
        footerTags: ['≥55°F', '≥60°F', '≥65°F', '≥70°F', 'ISP Climatology'],
      ...
      },
      {
        ...
        description:'Probability of hourly temperatures meeting or exceeding key heat and cold thresholds at Islip — visualizing extreme temperature patterns by hour and day of year.',
        footerTags: ['≥90°F', '≥80°F', '≤32°F', '≤20°F', 'ISP Climatology'],
      ...
      },
      {
        ...
        description:'Monthly and seasonal frequency of fog events at Islip — visibility patterns and year-over-year trends across the climatological record.',
        footerTags: ['Fog Days', 'Visibility', 'ISP Climatology'],
        to:         '/fog-heatmap',
        accentVar:  '--accent-hourly',
      ...
      },
      {
        ...
        description:'Monthly frequency of thunderstorm days at Islip — seasonal patterns of convective activity across the full climatological record.',
        footerTags: ['Thunderstorm Days', 'Convective Activity', 'ISP Climatology'],
        to:         '/thunderstorm-heatmap',
        accentVar:  '--accent-hourly',
        thumb:      '/ThunderstormHeatmap_thumbnail.png',
      },
      {
        tags:       ['ISP', 'WINTER', 'PRECIPITATION'],
        title:      'Winter Precipitation Heatmap',
        description:'Heatmap of winter precipitation types and totals at Islip — rain, snow, sleet, and freezing rain patterns through the cold season.',
        footerTags: ['Snow', 'Sleet', 'Freezing Rain', 'ISP Climatology'],
